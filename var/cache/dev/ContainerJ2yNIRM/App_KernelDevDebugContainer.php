...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\VerificationController' => 'getVerificationControllerService',
            ...
            'vich_uploader.namer_origname.product_images' => 'getVichUploader_NamerOrigname_ProductImagesService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xypirjHe16', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1k1+hC4HWR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KMHa2Dyybq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D21xpCO9cC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\CartController', 'App\\Controller\\CategoryController', 'App\\Controller\\HomeController', 'App\\Controller\\OrderController', 'App\\Controller\\ProductController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'App\\Controller\\VerificationController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver(($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), 'D:\\symfony/public', 'media/cache');
    }
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'D:\\symfony/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('D:\\symfony/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['D:\\symfony\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'D:\\symfony\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'D:\\symfony', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p+xhbUAfjD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nUXjZJSw-J', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A0FQZiKNbD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('scnNwkiwS4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wRzbKlw7QI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+xHOI9vN4F', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'D:\\symfony', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        ...
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.product_images'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.product_images'], [['postFlush'], 'vich_uploader.listener.remove.product_images'], [['prePersist'], 'vich_uploader.listener.upload.product_images'], [['preUpdate'], 'vich_uploader.listener.upload.product_images']]);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['D:\\symfony\\src\\Entity'], true)), 'App\\Entity');
    ...
    {
        $container->privates['doctrine.orm.default_xml_metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(['D:\\symfony\\vendor\\vich\\uploader-bundle\\config\\doctrine' => 'Vich\\UploaderBundle\\Entity'], '.orm.xml', true);
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'D:\\symfony', true);
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['D:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'D:\\symfony\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'D:\\symfony\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['D:\\symfony\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'D:\\symfony\\v
\\symfony\\vendor\\twig\\extra-bundle/translations', 'D:\\symfony\\vendor\\symfony\\security-bundle/translations', 'D:\\symfony\\vendor\\symfony\\monolog-bundle/translations', 'D:\\symfony\\vendor\\symfony\\maker-bundle/translations', 'D:\\symfony\\vendor\\doctrine\\doctrine-fixtures-bundle/translations', 'D:\\symfony\\vendor\\liip\\imagine-bundle/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'D:\\symfony');
        $a->addPath('D:\\symfony\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('D:\\symfony\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('D:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('D:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('D:\\symfony\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('D:\\symfony\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('D:\\symfony\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('D:\\symfony\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('D:\\symfony\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('D:\\symfony\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('D:\\symfony\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('D:\\symfony\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('D:\\symfony\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('D:\\symfony\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('D:\\symfony\\vendor\\knplabs\\knp-paginator-bundle/templates', 'KnpPaginator');
        $a->addPath('D:\\symfony\\vendor\\knplabs\\knp-paginator-bundle/templates', '!KnpPaginator');
        $a->addPath('D:\\symfony\\vendor\\liip\\imagine-bundle/Resources/views', 'LiipImagine');
        $a->addPath('D:\\symfony\\vendor\\liip\\imagine-bundle/Resources/views', '!LiipImagine');
        $a->addPath('D:\\symfony\\vendor\\vich\\uploader-bundle/templates', 'VichUploader');
        $a->addPath('D:\\symfony\\vendor\\vich\\uploader-bundle/templates', '!VichUploader');
        $a->addPath('D:\\symfony/templates');
        $a->addPath('D:\\symfony\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('D:\\symfony\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('D:\\symfony\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension($h, 'D:\\symfony', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['D:\\symfony\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'D:\\symfony\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'D:\\symfony\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'D:\\symfony\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'D:\\symfony\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'DoctrineFixturesBundle' => [
                    'path' => 'D:\\symfony\\vendor\\doctrine\\doctrine-fixtures-bundle',
                    'namespace' => 'Doctrine\\Bundle\\FixturesBundle',
                ],
                'KnpPaginatorBundle' => [
                    'path' => 'D:\\symfony\\vendor\\knplabs\\knp-paginator-bundle',
                    'namespace' => 'Knp\\Bundle\\PaginatorBundle',
                ],
                'LiipImagineBundle' => [
                    'path' => 'D:\\symfony\\vendor\\liip\\imagine-bundle',
                    'namespace' => 'Liip\\ImagineBundle',
                ],
                'VichUploaderBundle' => [
                    'path' => 'D:\\symfony\\vendor\\vich\\uploader-bundle',
                    'namespace' => 'Vich\\UploaderBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'App_KernelDevDebugContainer',
            'product_images_directory' => 'D:\\symfony/public/uploads/products',
            ...
            'translator.default_path' => 'D:\\symfony/translations',
            ...
            'twig.default_path' => 'D:\\symfony/templates',
            ...
            'vich_uploader.mappings' => [
                'product_images' => [
                    ...
                    'upload_destination' => 'D:\\symfony/public/images/products',
                    'namer' => [
                        'service' => 'vich_uploader.namer_origname.product_images',
                        'options' => [
