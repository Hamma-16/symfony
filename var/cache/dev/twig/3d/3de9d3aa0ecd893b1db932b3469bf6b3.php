...
class __TwigTemplate_f284bb8fede6a7abbb12f6644a471328 extends Template
{
    ...
    ";
            ...
            yield "\">Connectez-vous</a> pour accéder à votre compte.
        </p>
        <p>
            Vous pouvez aussi <a href=\"";
            // line 25
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_product_index");
            yield "\">parcourir les produits</a> sans compte.
        </p>
    ";
        }
        // line 28
...
";
    ...
    {
        return array (  149 => 28,  143 => 25,  137 => 22,  134 => 21,  127 => 17,  123 => 16,  119 => 15,  115 => 14,  107 => 10,  105 => 9,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"container mt-5\">
    ...
    {% if app.user %}
        ...
        <nav>
            <ul>
                <li><a href=\"{{ path('app_product_index') }}\">Voir les produits</a></li>
                <li><a href=\"{{ path('app_cart') }}\">Voir mon panier</a></li>
                <li><a href=\"{{ path('app_order_index') }}\">Mes commandes</a></li>
                <li><a href=\"{{ path('app_logout') }}\">Déconnexion</a></li>
            </ul>
        </nav>
    {% else %}
        <p>
            <a href=\"{{ path('app_login') }}\">Connectez-vous</a> pour accéder à votre compte.
        </p>
        <p>
            Vous pouvez aussi <a href=\"{{ path('app_product_index') }}\">parcourir les produits</a> sans compte.
        </p>
    {% endif %}
</div>
{% endblock %}
